        ...
        <div class="containerInputs">
            ...
            <section>
                ...
                <Dropdown id="role" v-model="selectedType" :options="roleOptions" placeholder="Select a Role"
                    option-label="label" option-value="value" class="bg-white/20 border-0 p-4 text-primary-50">
                </Dropdown>
            </section>
            <section>
            ...
            <section>
                ...
                <InputText id="Email" class="bg-white/20 border-0 p-4 text-primary-50" v-model="emailInput" />
            </section>
            ...
            <section>
                ...
                <InputText id="location" class="bg-white/20 border-0 p-4 text-primary-50" v-model="locationInput" />
            </section>
            ...
            <section>
                <PrimaryButton @click="[visibleLoadingDialog = true, submitCreatePlace()]" text="Submit"
                    class=" text-[#f0f0f0] " style="font-size: 1.5rem  " />
            </section>
        </div>
