...
<template>
  <footer class="text-gray-500   md:px-10">
    <div class="gap-6 justify-between md:flex">
      <div class="flex-1">
        <div class="max-w-xs">
          <div class="flex items-center">
            <router-link
              ...
              ><img src="/src/presentation/components/icons/Logo.png" alt="" width="60px"/>
            </router-link>
            <h1 class="text-blue-400 font-bold">Deal</h1>
        ...
        <form @submit.prevent>
          <label class="block pt-4 pb-2 font-bold">Stay up to date</label>
          <div class="max-w-sm flex items-center border rounded-md p-1">
            ...
            <button class="bg-white">
              <img src="/src/presentation/components/icons/AddEmailLogo.png" alt="" width="50px" />
            </button>
          </div>
        </form>
      </div>
      <div class="flex-1 mt-10 space-y-6 items-center justify-between sm:flex md:space-y-0 md:mt-0">
        <ul v-for="(item, index) in footerNavs" :key="index" class="space-y-4">
          <h4 class="text-gray-800 font-medium">{{ item.label }}</h4>
          <li v-for="(el, idx) in item.items" :key="idx">
            <router-link :to="el.route" class="hover:underline hover:text-indigo-600">
              {{ el.name }}
            </router-link>
          </li>
        </ul>
    ...
    <div class="mt-8 py-6 border-t items-center justify-between sm:flex">
      <div class="mt-4 sm:mt-0">©2024DealDiscover.com</div>
