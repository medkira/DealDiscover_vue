<template>
    ...
    <Dialog :close-on-escape="true" class="'w-[370px]" :dismissable-mask="true" v-model:visible="visible" modal :pt="{
        ...
        <div class="form-container">
            ...
            <form class="form"
                @submit.prevent="[resetPassword(), showSuccess('Reset password link sent succesfuly! check your inbox')]">
...
const resetPassword = async () => {
    await appServiceClientInstance.resetPassword({ email: email.value });
    email.value = ""

}
const toast = useToast();
const showSuccess = (msg: string) => {
    toast.add({ severity: 'success', summary: 'Success Message', detail: msg, life: 5000, group: 'tl' });
};
